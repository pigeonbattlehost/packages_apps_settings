    ...
    NetworkOperatorPreference updateAllPreferenceCategory() {
        ...
        for (int index = 0; index < mCellInfoList.size(); index++) {
            ...
            if (mCellInfoList.get(index).isRegistered()) {
                ...
                String info = getCellDebugInfo(cellInfo);
...
private String getCellDebugInfo(CellInfo cellInfo) {
    ...
    try {
        ...
        if (cellInfo instanceof android.telephony.CellInfoLte) {
            ...
            android.telephony.CellInfoLte lte =
                    (android.telephony.CellInfoLte) cellInfo;

            android.telephony.CellSignalStrengthLte sig =
                    lte.getCellSignalStrength();
        ...
        if (android.os.Build.VERSION.SDK_INT >= 29
            ...
            android.telephony.CellInfoNr nr =
                    (android.telephony.CellInfoNr) cellInfo;

            android.telephony.CellSignalStrengthNr sig =
                    (android.telephony.CellSignalStrengthNr)
                            nr.getCellSignalStrength();
